...
class _HomeScreenState extends State<HomeScreen> {
  ...
  Widget _buildPage(int index) {
    return _cache.putIfAbsent(index, () {
      switch (index) {
        case 0: return const AccueilScreen();
        case 1: return const CatalogueScreen();
        case 2: return const ScannerScreen();
        case 3: return const PanierScreen();
        case 4: return const CompteScreen();
        default: return const AccueilScreen();
      }
    });
  }
    ...
    return Scaffold(
      ...
      bottomNavigationBar: BottomNavigationBar(
        ...
        items: [
          ...
          // Magasins accessible via icône AppBar — pas de tab dédié
        ],
      ),
    );
  }
