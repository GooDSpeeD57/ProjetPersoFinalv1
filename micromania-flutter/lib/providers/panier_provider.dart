...
class PanierProvider extends ChangeNotifier {
  ...
  Future<bool> addLigne(int idVariant, int quantite, {int? idTypeGarantie}) async {
    try {
      _panier = await _service.addLigne(
        idVariant: idVariant,
        quantite: quantite,
        idTypeGarantie: idTypeGarantie,
      );
      notifyListeners();
      return true;
    } catch (e) {
