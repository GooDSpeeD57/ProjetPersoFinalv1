...
public interface PanierMapper {
    ...
    @Mapping(target = "categorieId",     expression = "java(ligne.getVariant().getProduit() != null && ligne.getVariant().getProduit().getCategorie() != null ? ligne.getVariant().getProduit().getCategorie().getId() : null)")
    @Mapping(target = "statutProduit",   expression = "java(ligne.getVariant().getStatutProduit() != null ? ligne.getVariant().getStatutProduit().getCode() : null)")
