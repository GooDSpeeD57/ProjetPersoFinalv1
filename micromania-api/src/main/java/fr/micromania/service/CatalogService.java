...
public interface CatalogService {
    ...
    /** Retourne le produit complet dont un variant a cet EAN. 404 si introuvable. */
    ProduitResponse getProduitByEan(String ean);
    ...
    /** Calendrier des sorties : produits dont dateSortie >= aujourd'hui (ou précommande), triés par date ASC. */
    List<ProduitSortieItem> getCalendrier();
}
