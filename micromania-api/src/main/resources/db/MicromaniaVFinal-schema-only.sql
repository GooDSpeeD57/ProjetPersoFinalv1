...
DROP TABLE IF EXISTS horaire_magasin;
...
CREATE TABLE horaire_magasin (
    ...
    ferme            BOOLEAN     NOT NULL DEFAULT FALSE COMMENT '1 = magasin fermé ce jour',
    PRIMARY KEY (id),
    CONSTRAINT uq_horaire_magasin_jour UNIQUE (id_magasin, jour_semaine),
...
CREATE TABLE garantie (
    ...
    id_type_garantie BIGINT NULL,              -- NULL = garantie légale de conformité (pas d'extension souscrite)
    date_debut       DATE NOT NULL,
    date_fin         DATE NOT NULL,
